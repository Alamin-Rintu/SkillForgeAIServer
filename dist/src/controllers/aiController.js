...
exports.interviewChat = exports.recommendCareer = exports.analyzeResume = exports.generateRoadmap = void 0;
...
Return ONLY valid JSON matching this structure:
{
  ...
  "suggestedImprovements": ["Actionable improvement 1", "Actionable improvement 2"]
                ...
                const cleanJson = text.replace(/```json/g, '').replace(/```/g, '').trim();
                const parsed = JSON.parse(cleanJson);
                await ResumeAnalysis_1.default.create({
...
const recommendCareer = async (req, res) => {
    try {
        ...
        await CareerRecommendation_1.default.create({
            userId: req.body.userId || 'demo-user-123',
            targetJob,
...
exports.recommendCareer = recommendCareer;
...
exports.interviewChat = interviewChat;
